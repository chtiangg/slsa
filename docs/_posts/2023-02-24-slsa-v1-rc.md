...
[SLSA v1.0 RC1 Specification](/v1.0-rc1) by **March 24, 2023**,
...
needed to meet
[all requirements in each of the four areas](/v0.1/requirements).
...
Track Levels 1-3](/v1.0-rc1/levels#build-track) roughly
correspond to
[Levels 1-3 of v0.1](/v1.0-rc1/requirements#build-requirements),
...
currently have [plans](/v1.0-rc1/future-directions) for Build
Level 4 and a Source Track.

The v1.0 RC also defines the [principles](/v1.0-rc1/principles)
...
**[Producing artifacts](/v1.0-rc1/requirements)** explains
...
**[Verifying build systems](/v1.0-rc1/verifying-systems)**
...
**[Verifying artifacts](/v1.0-rc1/verifying-artifacts)**
