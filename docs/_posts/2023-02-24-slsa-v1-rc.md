...
[SLSA v1.0 RC1 Specification](/v1.0) by **March 24, 2023**,
...
Track Levels 1-3](/v1.0/levels#build-track) roughly
correspond to
[Levels 1-3 of v0.1](/v1.0/requirements#build-requirements),
...
currently have [plans](/v1.0/future-directions) for Build
Level 4 and a Source Track.

The v1.0 RC also defines the [principles](/v1.0/principles)
...
**[Producing artifacts](/v1.0/requirements)** explains
...
**[Verifying build systems](/v1.0/verifying-systems)**
