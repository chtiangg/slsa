...
[the GitHub Actions example](/provenance#github-actions)).

If the build isn't defined in code it MAY list the details of what it was
asked to do (as in
[the Google Cloud Build RPC example](/provenance#cloud-build-rpc)
or
[the Explicitly Run Commands example](/provenance#explicitly-run-commands)).
