    ...
    <div class="wrapper inner w-full">
        <div class="flex flex-wrap justify-between items-start">
            ...
            <div class="w-full md:w-1/2 md:mt-0 mt-8">
                ...
                <a href="/v1.0/threats-overview" class="cta-link h5 font-semibold mt-8">More about supply chain attacks</a>
            </div>
        </div>
    ...
    <div class="wrapper inner w-full">
        <div class="flex flex-wrap justify-between items-center">
            <div class="text w-full md:w-1/2">
                ...
                <a href="/v1.0/levels" class="cta-link h5 font-semibold mt-8">Read the level specifications</a>
            </div>
    ...
    <div class="wrapper inner w-full">
        ...
        <div class="flex flex-wrap justify-center w-6/7 mx-auto md:-ml-4">
            ...
            <div class="w-full md:w-1/2 getting_started_card md:pl-4">
              <a href="/v1.0/" class="hover:no-underline">
                  <div class="bg-white h-full rounded-lg p-10 flex flex-col">
    ...
    <div class="wrapper inner w-full">
        <div class="flex flex-wrap justify-between items-start text-white">
            ...
            <div class="w-full md:w-1/2">
                ...
                <p>
                <a href="/v1.0/">SLSA v1.0</a> is now available, released in April 2023.
                We expect the specification to remain stable, with future versions expanding its breadth and depth.
                For more information about this release, see <a href="/v1.0/whats-new">What's new in v1.0</a>.
                <br><br>
